    ...
    <header class="top-nav">
      <div class="nav-container">
        ...
        <nav class="nav-tabs">
          ...
          <router-link to="/restocking" :class="{ active: $route.path === '/restocking' }">Restocking</router-link>
...
<style>
/* Dark Navy & Pink Theme Color Palette */
:root {
  /* Primary Colors - Navy */
  --color-navy-dark: #0f1729;
  --color-navy-darker: #0a0f1a;
  --color-navy-medium: #1a2640;
  --color-navy-light: #2d3f5b;
...
.top-nav {
  background: linear-gradient(135deg, var(--color-navy-darker) 0%, var(--color-navy-dark) 100%);
