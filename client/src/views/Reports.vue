  ...
  setup() {
    ...
    const loadData = async () => {
      try {
        ...
        error.value = t('reports.error.loadFailed')
    ...
    // Format bar height as percentage
    const getBarHeight = (revenue) => {
      return (revenue / maxRevenue.value) * 200
    }

    // Get fulfillment badge class
