<template>
  <div class="orders">
    ...
    <div v-else>
      ...
      <div v-if="getOrdersByStatus('Submitted').length > 0" class="card submitted-orders-card">
        <div class="card-header">
          <h3 class="card-title">{{ t('status.submitted') }} ({{ getOrdersByStatus('Submitted').length }})</h3>
        </div>
